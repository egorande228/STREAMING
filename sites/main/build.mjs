...
const files = ['index.html', 'news.html', 'admin.html', 'app.js', 'team-names.js', 'team-crest-assets.js', 'news.js', 'curated-news.js', 'admin.js', 'analytics-init.js', 'theme.js', 'url-propagation.js', 'styles.css', 'admin.css', 'config.js', '_headers', '_redirects', 'assets'];
