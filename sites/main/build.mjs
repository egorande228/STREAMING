...
const files = ['index.html', 'news.html', 'admin.html', 'app.js', 'news.js', 'admin.js', 'url-propagation.js', 'meta-pixel.js', 'styles.css', 'admin.css', 'config.js', '_headers', '_redirects', 'assets'];
