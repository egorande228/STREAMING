(function () {
  ...
  if (document.documentElement) {
    document.documentElement.lang = normalizedPreferredLang || 'en';
    document.documentElement.dir = normalizedPreferredLang === 'ar' ? 'rtl' : 'ltr';
  }
  ...
  function socialLinkCopy(item = {}) {
    const langCopy = socialBenefitCopyByLang[normalizedPreferredLang] || socialBenefitCopyByLang.en;
    const benefit = langCopy[item.brand] || socialBenefitCopyByLang.en[item.brand] || {};
